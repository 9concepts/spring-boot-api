...
class CourseControllerIntegrationTests {
    ...
    fun addCourse() {
        ...
        val courseDTO = CourseDTO(null, "Build Restful APIs using SpringBoot and Kotlin", "9sako6", instructor.id)
    ...
    internal fun updateCourse() {
        ...
        val updatedCourseDTO =
            CourseDTO(null, "Build Restful APIs using SpringBoot and Kotlin1", "Development", instructor.id)
